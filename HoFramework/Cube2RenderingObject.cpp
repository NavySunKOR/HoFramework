...
void HCube2RenderingObject::Initialize()
{
	...
	//Shaders
	HRenderingLibrary::CreateVertexShader(device, m_vertexShader, m_vertexInputLayout, L"VertexShader.hlsl");
...
void HCube2RenderingObject::Update()
{
	...
	m_transformConstData.ModelTransform = (Matrix::CreateScale(0.05f) * Matrix::CreateRotationY(RotationYValue) * Matrix::CreateRotationX(RotationXValue) * Matrix::CreateTranslation(0.25f, 0.25f, 0)).Transpose();
